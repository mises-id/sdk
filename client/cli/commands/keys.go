...
`,
	...
	cmd.PersistentFlags().String(flags.FlagKeyringDir, defaultNodeHome+"/sdk-keyring", "The client Keyring directory; if omitted, the default 'home' directory will be used")
